Public Class VideoList
    ...
    Private Sub DGV_videoList_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DGV_videoList.CellContentClick
        ...
        'MsgBox(Me.dgv_user.Rows(e.RowIndex).Cells(e.ColumnIndex).Value)

        MsgBox(Me.DGV_videoList.Rows(dg.CurrentCell.RowIndex).Cells(dg.CurrentCell.ColumnIndex).Value)
